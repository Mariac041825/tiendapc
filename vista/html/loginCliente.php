...
if(isset($_SESSION['user'])){
    header("location: index.php?accion=loginCliente&ver&id=".$_GET['id']);
    exit();
}
?>
<!DOCTYPE html> 
...
<body>
  ...
  <section id="admin">
    ...
    <form action="index.php?accion=loginCliente&ingresar" method="post">
      ...
      <button><a href="index.php?accion=registroCliente">Registrarse</a></button>
    </form>
  </section>
